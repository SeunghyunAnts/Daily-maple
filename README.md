...
# 매일메일 (DailyMaple)  
English version description [here](#dailymaple)  
  
## 매일메일  
겨울방학 토이 프로젝트 (2020.12. ~ 2021.02.) <br />  
- 이메일 : seunghyun4525@gmail.com <br />  
- 데모 영상 : (추가 예정) <br />  
- 기여자 : [high2092](https://github.com/high2092), [tmdgus2568](https://github.com/tmdgus2568) <br />  
...
Winter Vacation Toy Project (2020.12. ~ 2021.02.) <br />  
- Email : seunghyun4525@gmail.com <br />  
- Demo Video : (추가 예정) <br />  
- Contributors : high2092, tmdgus2568 <br />  
  
## Introduction  
This is an application that records the contents of an online game called Maple Story and notifies you if necessary. <br />  
1. Add a character. <br />  
2. Set the contents to be recorded by each character. <br />  
3. Specify a character that needs notification. <br />  
