...
public class ViewPagerAdapter extends RecyclerView.Adapter<ViewHolderPage> {
    ...
    private ArrayList<CharacterInfo> listData;

    ViewPagerAdapter(ArrayList<CharacterInfo> data) {
        this.listData = data;
    }
    ...
    public ViewHolderPage onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.character_viewpager, parent, false);
